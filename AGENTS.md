...
Whenever you add or change a V2 query or mutation resolver, review these four areas before merging. Look at similar resolvers in the same file for established patterns. Also consult the [GraphQL Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/GraphQL_Cheat_Sheet.html) and [Authorization Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Cheat_Sheet.html) where relevant.
